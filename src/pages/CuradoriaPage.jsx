      ...
      <div className="bg-primary text-white py-12">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="text-center">
            ...
            <h1 className="text-3xl md:text-4xl text-white font-bold mb-2">Como funciona a curadoria no sabIA</h1>
            <p className="text-lg text-white opacity-90">Nosso processo de seleção e análise</p>
          </div>
        </div>
      </div>
